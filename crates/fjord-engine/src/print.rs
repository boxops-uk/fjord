...
/// ([chapter 7](../../../web/src/content/query-language.mdx)). One constant part can cover
...
/// self-delimiting ([I2](../../../web/src/content/invariants.mdx#i2)), so the run is split by
...
/// these bytes ([I1](../../../web/src/content/invariants.mdx#i1)). So the terminator is put back
