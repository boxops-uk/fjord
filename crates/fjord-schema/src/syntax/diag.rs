...
pub enum Code {
    ...
    ///
    /// [I10](https://github.com/boxops-uk/fjord/blob/main/web/src/content/invariants.mdx#i10) is
    ...
    /// half of [I10](https://github.com/boxops-uk/fjord/blob/main/web/src/content/invariants.mdx#i10),
