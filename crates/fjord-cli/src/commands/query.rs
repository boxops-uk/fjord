...
pub struct Summary {
    ...
    /// both column families are written together ([I12](../../../../web/src/content/invariants.mdx#i12))
    /// and ids are never reused ([I11](../../../../web/src/content/invariants.mdx#i11)) — so it is reported
...
pub fn run(
    ...
    // ([I13](../../../../web/src/content/invariants.mdx#i13)), and a tool that refused to *read* a
...
mod mixed {
    ...
    /// **Paging across a mixed plan**, which is [I4](../../../../web/src/content/invariants.mdx#i4) over a
...
mod surface {
    ...
    /// not there is corruption ([I11](../../../../web/src/content/invariants.mdx#i11),
    /// [I12](../../../../web/src/content/invariants.mdx#i12)); a *catalogue* row that is not there is a
