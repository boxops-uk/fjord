...
/// ([I6](https://github.com/boxops-uk/fjord/blob/main/web/src/content/invariants.mdx#i6)).
///
...
/// together ([I12](https://github.com/boxops-uk/fjord/blob/main/web/src/content/invariants.mdx#i12)) and ids are never reused
/// ([I11](https://github.com/boxops-uk/fjord/blob/main/web/src/content/invariants.mdx#i11)) — so the server answers "nothing" and lets
...
/// its snapshot already released ([I8](https://github.com/boxops-uk/fjord/blob/main/web/src/content/invariants.mdx#i8)) — and the
/// concatenation of the pages must equal an uninterrupted run of the same query, which
/// is [I4](https://github.com/boxops-uk/fjord/blob/main/web/src/content/invariants.mdx#i4) seen from a client.
#[test]
...
/// is checked by containment and let in ([I13](https://github.com/boxops-uk/fjord/blob/main/web/src/content/invariants.mdx#i13), and
...
/// rows, same order, no gap and no repeat — [I4](https://github.com/boxops-uk/fjord/blob/main/web/src/content/invariants.mdx#i4)
...
/// the case [I4](https://github.com/boxops-uk/fjord/blob/main/web/src/content/invariants.mdx#i4)
...
/// [`ops-I4`](https://github.com/boxops-uk/fjord/blob/main/web/src/content/operations.mdx) actually needs: *which* producer is
