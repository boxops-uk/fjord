...
EXPECTED_NON_GUARDS = {
    ...
    # Loads a JSONL export of a real index. The export is built by indexing a
    # checkout — MSBuild, a server and a minute — so it is named by an environment
    # variable and run on purpose, not carried in the repository.
    "a_real_index_loads_from_its_dump_and_answers",
}
